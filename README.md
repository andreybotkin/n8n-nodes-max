...
- Интерактивные клавиатуры с кнопками (через интерфейс n8n fixedCollection или динамический параметр `Inline Keyboard JSON`, поддерживающий выражения n8n и структуры Max API)
